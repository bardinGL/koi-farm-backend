...
INSERT INTO [dbo].[User]
           ...
           ,[DeletedAt])
VALUES
           ('aa5fd505e603484ba3abd30223d0c29f' ,'manager', 'manager@gmail.com', '123456', NULL, '0934140524', '1','Active', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
           ('bb6fd505e603484ba3abd30223d0c29f', 'staff', 'staff@gmail.com', '123456', NULL, '0934140525', '2','Active', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL)
GO
...
VALUES
    ...
    SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
	('11', 'Koi Matsuba', 100, 'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027774/products/matsuba.jpg', 
	...
	SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('12', 'Koi KikoKryu', 100, 'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027737/products/kikokryu.jpg', 
	...
	SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('13', 'Koi Ochiba', 100, 'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027785/products/ochiba.jpg', 
	N'Matsuba là một loại cá Koi có màu kim loại với hoa văn lưới màu đen. Cơ thể của cá koi Matsuba có một màu với vảy hình nón thông. Loại cá này có lớp vảy óng ánh vô cùng đẹp mắt. Để tìm hiểu kỹ hơn về giống cá Koi Matsuba này hãy cùng tham khảo bài viết dưới đây của chúng tôi nhé', 
	SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL);
GO
...
VALUES
    ...
    ('1', 'Koi Kohaku - #0001', 1000000, 'Japan', 'Unknown', 2, 'Medium', 'Koi', 'Calm', '50', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('2', 'Koi Kohaku - #0002', 1200000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Calm', '55', '21', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('3', 'Koi Kohaku - #0002', 1400000,  'Japan', 'Male', 3, 'Large', 'Koi', 'Joyful', '55', '21', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('4', 'Koi Kohaku - #0003', 1600000,  'Japan', 'Male', 3, 'Medium', 'Koi', 'Joyful', '55', '21', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('5', 'Koi Kohaku - #0004', 200000,  'Japan', 'Male', 3, 'Medium', 'Koi', 'Friendly', '55', '21', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('6', 'Koi Kohaku - #0005', 1100000,  'Japan', 'Male', 3, 'Medium', 'Koi', 'Active', '55', '21', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Ogon'
    ('7', 'Koi Ogon - #0001', 1500000, 'Japan', 'Unknown', 3, 'Large', 'Koi', 'Active', '70', '18', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
    '2', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('8', 'Koi Ogon - #0002', 1550000, 'Japan', 'Female', 2, 'Large', 'Koi', 'Friendly', '75', '19', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
    '2', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('9', 'Koi Ogon - #0003', 1550000, 'Japan', 'Male', 2, 'Large', 'Koi', 'Joyful', '75', '19', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
    '2', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('10', 'Koi Ogon - #0004', 1550000, 'Japan', 'Male', 2, 'Large', 'Koi', 'Aggressive', '70', '22', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
    '2', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('11', 'Koi Ogon - #0005', 1550000, 'Japan', 'Female', 2, 'Large', 'Koi', 'Friendly', '75', '19', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
    '2', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Showa'
    ('12', 'Koi Showa - #0001', 2000000, 'Japan', 'Male', 1, 'Large', 'Koi', 'Aggressive', '80', '22', 'Low', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027838/products/showa.jpg', 1, 'Approved', 
    '3', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('13', 'Koi Showa - #0002', 2000000, 'Japan', 'Male', 1, 'Large', 'Koi', 'Friendly', '80', '22', 'Low', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027838/products/showa.jpg', 1, 'Approved', 
    '3', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('14', 'Koi Showa - #0003', 2000000, 'Japan', 'Male', 1, 'Large', 'Koi', 'Shy', '80', '22', 'Low', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027838/products/showa.jpg', 1, 'Approved', 
    '3', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('15', 'Koi Showa - #0004', 2000000, 'Japan', 'Male', 1, 'Large', 'Koi', 'Aggressive', '80', '20', 'Low', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027838/products/showa.jpg', 1, 'Approved', 
    '3', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Tancho'
    ('16', 'Koi Tancho - #0001', 1200000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Shy', '60', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
    '4', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('17', 'Koi Tancho - #0002', 1200000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Shy', '60', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
    '4', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('18', 'Koi Tancho - #0003', 1200000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Shy', '60', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
    '4', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Bekko'
    ('21', 'Koi Bekko - #0001', 1200000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Shy', '60', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
    '5', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('20', 'Koi Bekko - #0002', 1200000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Shy', '60', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
    '5', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('19', 'Koi Bekko - #0003', 1100000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Aggressive', '60', '18', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028081/products/bekko.jpg', 1, 'Approved', 
    '5', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
	
	 -- ProductItems for 'Koi Asagi'
    ('22', 'Koi Asagi - #0001', 1300000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Calm', '65', '22', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028100/products/asagi.jpg', 1, 'Approved', 
    '6', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('23', 'Koi Asagi - #0002', 1250000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Active', '63', '21', 'Healthy', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028100/products/asagi.jpg', 1, 'Approved', 
    '6', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Shusui'
    ('24', 'Koi Shusui - #0001', 1350000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Docile', '68', '23', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028120/products/shusui.jpg', 1, 'Approved', 
    '7', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('25', 'Koi Shusui - #0002', 1280000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Peaceful', '66', '22', 'Healthy', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028120/products/shusui.jpg', 1, 'Approved', 
    '7', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Utsuri'
    ('26', 'Koi Utsuri - #0001', 1400000, 'Japan', 'Female', 2, 'Large', 'Koi', 'Bold', '70', '25', 'Healthy', '9', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028140/products/utsurimono.jpg', 1, 'Approved', 
    '8', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('27', 'Koi Utsuri - #0002', 1320000, 'Japan', 'Male', 3, 'Large', 'Koi', 'Assertive', '68', '24', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028140/products/utsurimono.jpg', 1, 'Approved', 
    '8', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Goshiki'
    ('28', 'Koi Goshiki - #0001', 1450000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Friendly', '67', '23', 'Healthy', '9', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028160/products/goshiki.jpg', 1, 'Approved', 
    '9', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('29', 'Koi Goshiki - #0002', 1380000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Sociable', '65', '22', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028160/products/goshiki.jpg', 1, 'Approved', 
    '9', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Kujaku'
    ('30', 'Koi Koromo - #0001', 1500000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Gentle', '66', '23', 'Healthy', '9', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028180/products/kujaku.jpg', 1, 'Approved', 
    '10', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('31', 'Koi Koromo - #0002', 1420000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Calm', '64', '22', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028180/products/kujaku.jpg', 1, 'Approved', 
    '10', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
	
	 -- ProductItems for 'Koi Matsuba'
    ('32', 'Koi Matsuba - #0001', 1500000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Calm', '65', '22', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027774/products/matsuba.jpg', 1, 'Approved', 
    '11', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('33', 'Koi Matsuba - #0002', 1450000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Active', '63', '21', 'Healthy', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027774/products/matsuba.jpg', 1, 'Approved', 
    '11', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Kikokuryu'
    ('34', 'Koi Kikokuryu - #0001', 1600000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Docile', '68', '23', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027737/products/kikokryu.jpg', 1, 'Approved', 
    '12', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('35', 'Koi Kikokuryu - #0002', 1550000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Peaceful', '66', '22', 'Healthy', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027737/products/kikokryu.jpg', 1, 'Approved', 
    '12', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for 'Koi Ochiba'
    ('36', 'Koi Ochiba - #0001', 1550000, 'Japan', 'Female', 2, 'Medium', 'Koi', 'Gentle', '66', '23', 'Healthy', '9', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027785/products/ochiba.jpg', 1, 'Approved', 
    '13', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('37', 'Koi Ochiba - #0002', 1500000, 'Japan', 'Male', 3, 'Medium', 'Koi', 'Calm', '64', '22', 'Healthy', '8', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027785/products/ochiba.jpg', 1, 'Approved', 
    '13', '0', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL);
GO
...
VALUES
    ...
    ('pi-batch1-001', 'Koi Kohaku - #0006', 1050000,  'Japan', 'Unknown', 2, 'Medium', 'Koi', 'Territorial', '50', '20', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '1', 'batch-001', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('pi-batch1-002', 'Koi Kohaku - #0007', 1100000,  'Japan', 'Unknown', 3, 'Medium', 'Koi', 'Friendly', '60', '21', 'Medium', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027750/products/kohaku.jpg', 1, 'Approved', 
    '2', 'batch-001', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for Batch 1 (2 from Koi Ogon)
    ('pi-batch1-003', 'Koi Ogon - #0006', 1500000, 'Japan', 'Male', 3, 'Large', 'Koi', 'Territorial', '55', '18', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
    '3', 'batch-001', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('pi-batch1-004', 'Koi Ogon - #0008', 1550000,  'Japan', 'Female', 2, 'Large', 'Koi', 'Shy', '75', '19', 'High', '7', 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027798/products/ogon.jpg', 1, 'Approved', 
...
VALUES
    ...
    ('pi-batch2-001', 'Koi Showa - #0009', 2000000,  'Japan', 'Male', 1, 'Small', 'Koi', 'Shy', 80, 22, 'Low', 7, 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027838/products/showa.jpg', 1, 'Approved', 
    '1', 'batch-002', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('pi-batch2-002', 'Koi Showa - #0008', 2100000,  'Japan', 'Female', 3, 'Small', 'Koi', 'Friendly', 90, 21, 'Medium', 7, 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027838/products/showa.jpg', 1, 'Approved', 
    '2', 'batch-002', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),

    -- ProductItems for Batch 2 (2 from Koi Tancho)
    ('pi-batch2-003', 'Koi Tancho - #0007', 1200000,  'Japan', 'Female', 2, 'Small', 'Koi', 'Friendly', 60, 20, 'Medium', 7, 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
    '4', 'batch-002', SYSDATETIMEOFFSET(), SYSDATETIMEOFFSET(), NULL, 0, NULL),
    ('pi-batch2-004', 'Koi Tancho - #0008', 1250000,  'Japan', 'Male', 3, 'Large', 'Koi', 'Shy', 70, 22, 'Medium', 7, 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027860/products/tancho.jpg', 1, 'Approved', 
...
VALUES
    ...
    ('pi-batch3-001', 'Koi Bekko - #0008', 1150000,  'Japan', 'Unknown', 2, 'Medium', 'Koi', 'Calm', 60, 18, 'Medium', 7, 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728028081/products/bekko.jpg', 1, 'Approved', 
...
VALUES
    ...
    ('pi-batch4-001', 'Koi Ginrin - #0008', 1250000,  'Japan', 'Female', 3, 'Large', 'Koi', 'Friendly', 75, 22, 'Low', 7, 
    'https://res.cloudinary.com/dv7tuoxwb/image/upload/v1728027702/products/ginrin.jpg', 1, 'Approved', 
